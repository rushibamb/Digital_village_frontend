  ...
  const NavItemButton = ({ item, isMobile = false }: { item: typeof navItems[0], isMobile?: boolean }) => (
    ...
    >
      ...
      <item.icon className={`h-4 w-4 transition-all duration-300 ${
        currentPage === item.id ? 'animate-pulse-slow scale-110' : 'group-hover:scale-125 group-hover:rotate-12'
      }`} />
        ...
        <div className="flex h-16 items-center">
          ...
          <div className="flex items-center gap-3 ml-auto animate-slide-in-left">
            ...
            <Button
              ...
              className="gap-2 glass-effect border-indigo-200 text-indigo-600 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:text-white hover:border-transparent transition-all duration-300 hover-scale transform hover:rotate-1"
            >
            ...
            {isLoggedIn ? (
              <div className="hidden sm:flex items-center gap-3">
                <div className="flex items-center gap-2 glass-effect px-4 py-2 rounded-lg hover-glow transition-all duration-300 transform hover:scale-105">
              ...
              <Button
                ...
                className="hidden sm:flex gap-2 glass-effect border-blue-200 text-blue-600 hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-600 hover:text-white hover:border-transparent transition-all duration-300 hover-scale transform hover:rotate-1"
              >
          ...
          <div className="lg:hidden py-4 border-t border-white/30 glass-effect rounded-b-xl mt-2 animate-fade-in-up">
            <div className="flex flex-col gap-2">
              ...
              <Button
                ...
                className="w-full justify-start gap-3 glass-effect border-indigo-200 text-indigo-600 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:text-white hover:border-transparent transition-all duration-300"
              >
                <Settings className="h-4 w-4" />
                {t({ en: 'Admin Panel', mr: 'प्रशासन पॅनेल' })}
              </Button>
